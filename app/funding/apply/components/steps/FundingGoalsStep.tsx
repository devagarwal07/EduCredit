        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            ...
            },
            {
              ...
              description: "Fixed interest rate and repayment schedule",
            },
            {
            ...
            {
              name: "Flexible",
              description: "Open to various funding models depending on terms",
            },
          ].map((model) => (
            <div
              key={model.name}
              className={`p-4 rounded-lg border ${
                formData.preferredModel === model.name
                  ? "border-indigo-500 bg-indigo-500/10"
                  : "border-white/20 bg-white/5"
              } cursor-pointer transition-colors`}
              onClick={() => onChange("preferredModel", model.name)}
            >
