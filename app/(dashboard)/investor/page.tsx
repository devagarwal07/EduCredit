          ...
          >
            <div className="bg-primary-50 dark:bg-primary-950/20 rounded-lg p-4 flex flex-col">
              ...
              <span className="text-2xl font-bold">
                $
                <span className="stat-value" data-value={totalInvested / 1000}>
                  0
                </span>
                K
              </span>
                  ...
                  series: [
                    {
                      name: "Investment",
                      data: [
                        150000, 180000, 210000, 240000, 270000, 300000, 330000,
                        370000, 420000, 490000, 510000, 520000,
                      ],
                    },
                    {
                      name: "Returns",
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 w-64">
                <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMinCreditScore(parseInt(e.target.value))}
                    className="w-full"
                />
                <span className="text-sm font-medium w-10">{minCreditScore}</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-muted rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                ...
                transition to a new career. The milestone-based funding kept me
