          ...
          <table className="w-full min-w-[800px]">
            ...
            <tbody>
              ...
              <tr className="border-b">
                ...
                <td className="text-center py-4 px-4">Advanced</td>
                <td className="text-center py-4 px-4">Premium + Blockchain</td>
              </tr>
              <tr>
                ...
                <td className="text-center py-4 px-4">AI + Personal review</td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="testimonial bg-background border rounded-xl shadow-sm p-6">
            ...
            <p className="text-muted-foreground mb-2">
              ...
              learning journey. I secured funding for my education and landed my
              dream job."
            </p>
          ...
          <div className="testimonial bg-background border rounded-xl shadow-sm p-6">
            ...
            <p className="text-muted-foreground mb-2">
              "As a career changer, Premium Elite gave me everything I needed to
              transition into tech. The weekly mentoring sessions were
              invaluable."
            </p>
            <p className="text-sm font-medium">
