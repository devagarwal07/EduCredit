      ...
      >
        ...
        >
          ...
          >
            ...
            beautiful design with cutting-edge technology. With over 7 years of
            experience across the full development stack, I specialize in
        ...
        >
          ...
          >
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-2">Employment Status</h3>
            ...
            >
              ...
              <p className="text-gray-400">
                Available for remote work with flexible hours across global time
                zones.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  With over 7 years of experience in the tech industry, I've had
                  the privilege of working across the entire development stack,
                  from designing intuitive user interfaces to architecting
                  robust backend systems.
                </p>
                <p>
                  My journey began with a deep fascination for creating digital
                  experiences that feel natural and engaging. This passion led
                  me through various roles - from frontend developer to UI/UX
                  designer to full-stack engineer.
                </p>
                <p>
                  I believe that great products happen at the intersection of
                  beautiful design, innovative technology, and human-centered
                  thinking. This philosophy guides my approach to every project
                  I take on.
                </p>
                <p>
                  When I'm not coding or designing, you can find me exploring
                  the latest advancements in AI, contributing to open-source
                  projects, or hiking the beautiful trails around San Francisco.
                </p>
              </div>
